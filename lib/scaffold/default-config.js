...
/**
 * Will return the path and default schoolcore-node configuration. It will search for the
 * configuration file in the "~/.schoolcoin" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.schoolcoin');
  var defaultConfigFile = path.resolve(defaultPath, './schoolcore-node.json');
