...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `schoolcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ schoolcore-node add wallet-service');
      console.log('    $ schoolcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ schoolcore-node remove wallet-service');
      console.log('    $ schoolcore-node remove insight-api');
      console.log();
    });
